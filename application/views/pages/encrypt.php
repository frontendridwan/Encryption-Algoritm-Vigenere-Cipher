...
<body>
    ...
    <div class="container">
        <h1 class="mt-3 mb-3" align="center">Vigenere Cipher - Text Cryption</h1>
        <br>
        <form action="<?= base_url('home/encryptpage'); ?>" method="POST">
            <div class="form-group row">
                <label for="code" class="col-sm-2 col-form-label">Plaintext</label>
                <div class="col-sm-10">
        ...
        <div class="form-group row">
            <label for="hasil" class="col-sm-2 col-form-label">Ciphertext</label>
            <div class="col-sm-10">
